...
export const courseRegistry = [
  ...
  },
  {
    ...
    staticPackageUrl: '/course-geometry/royal-new-kent/course-v1.json',
    status: 'validation',
    packageStatus: 'validation',
    packageVersion: 'v1',
    packageCacheStatus: 'cached',
  ...
  },
  {
    ...
    staticPackageUrl: '/course-geometry/valhalla/course-v1.json',
    status: 'validation',
    packageStatus: 'validation',
    packageVersion: 'v1',
    packageCacheStatus: 'cached',
  ...
  },
  {
    ...
    staticPackageUrl: '/course-geometry/muirfield-village/course-v1.json',
    status: 'validation',
    packageStatus: 'validation',
    packageVersion: 'v1',
    packageCacheStatus: 'cached',
  ...
  },
  {
    ...
    staticPackageUrl: '/course-geometry/greywalls/course-v1.json',
    status: 'validation',
    packageStatus: 'validation',
    packageVersion: 'v1',
    packageCacheStatus: 'cached',
  ...
  },
  {
    ...
    staticPackageUrl: '/course-geometry/paynes-valley/course-v1.json',
    status: 'validation',
    packageStatus: 'validation',
    packageVersion: 'v1',
    packageCacheStatus: 'cached',
  ...
  },
  {
    ...
    gsproAliases: ['Augusta National', 'Augusta National Golf Club'],
    staticPackageUrl: '/course-geometry/augusta-national/course-v1.json',
    status: 'validation',
    packageStatus: 'validation',
    packageVersion: 'v1',
    packageCacheStatus: 'cached',
  ...
  {
    id: 'oakmont-country-club-oakmont-pa',
    name: 'Oakmont Country Club',
    location: 'Oakmont, PA',
    slug: 'oakmont-country-club',
    gsproAliases: ['Oakmont', 'Oakmont Country Club'],
    staticPackageUrl: '/course-geometry/oakmont-country-club/course-v1.json',
    status: 'validation',
    packageStatus: 'validation',
    packageVersion: 'v1',
    packageCacheStatus: 'cached',
  ...
  {
    id: 'erin-hills-erin-wi',
    name: 'Erin Hills',
    location: 'Erin, WI',
    slug: 'erin-hills',
    gsproAliases: ['Erin Hills', 'Erin Hills Golf Course'],
    staticPackageUrl: '/course-geometry/erin-hills/course-v1.json',
    status: 'validation',
    packageStatus: 'validation',
    packageVersion: 'v1',
    packageCacheStatus: 'cached',
