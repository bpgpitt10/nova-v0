...
import DecisionReplayDevPage from './dev/DecisionReplayDevPage.tsx'
...
function RootRouter() {
  ...
  const showDevPage = showCourseRenderDev || showCourseGeometryDev || showAimLab || showCaddieInputs || showGsproReplay || showDecisionReplay
