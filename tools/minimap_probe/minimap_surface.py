...
The minimap itself already exposes the current lie/surface as a persistent title.
This is especially valuable for tee-state detection because it is visible in the
practice-mode captures we already have: tee frames say `Tee`; the post-tee example
says `Fairway`.
"""
