...
Write-Host "Looper GSPro PASSIVE EVENT PROBE v3"
Write-Host "=================================="
...
Write-Host "It compares BOTH the latest DB Round row and currentRound-correlated row."
Write-Host "It preserves DB schema + opaque RoundSettings/RoundData changes for research."
